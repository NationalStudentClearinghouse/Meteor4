...
public class SecurityTokenImplTest extends TestCase {
	...
	@Test
	public void testToXMLString() throws SecurityException, NoSuchMethodException, SecurityTokenException, ParseException {
	...
	@Test
	public void testFromXML() throws IOException, SecurityTokenException, ParseException {
		String assertionXml = getXmlFromFile("assertion1.xml");
		SecurityToken result = SecurityTokenImpl.fromXML(assertionXml);
		Assert.assertEquals("meteornetwork.org", result.getIssuer());
