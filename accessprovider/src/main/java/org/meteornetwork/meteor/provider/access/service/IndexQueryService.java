...
public class IndexQueryService implements ApplicationContextAware {
	...
	public Set<DataProvider> getDataProviders(String ssn, ResponseDataWrapper responseData) {
		...
		String addresses[] = new String[] { "http://localhost:8080/indexprovider/services/IndexProviderService", "http://localhost:8080/indexprovider/services/IndexProviderService" };
